<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update-beer.aspx.cs" Inherits="updateBeer" %>
            ...
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6" style="background-color:#BD8D46">
                <div class="registrationform col-lg-offset-1">
                    <div class="form-horizontal">
                        <fieldset>
                            <legend>Update Beer <i class="fa fa-pencil pull-right"></i></legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5" style="width:450px">
                                    <asp:TextBox ID="newDescription" runat="server" TextMode="MultiLine" Rows="1" CssClass="form-control2" OnTextChanged="newDescription_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-lg-8 col-lg-offset-4">
                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-warning" Text="Submit" OnClick="actualizarCerveza"/>
