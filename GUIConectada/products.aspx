                        ...
                        <fieldset class="col-lg-offset-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList ID="searchFerType" runat="server" CssClass="form-control ddl" Visible="false" style="width:200px;"></asp:DropDownList>
                                    </div>
                            ...
                            <div class="form-group" style="margin-top:40px">
                                <asp:Button ID="btnSearchBeer" runat="server" CssClass="col-lg-2 col-lg-offset-4 btn2 btn-warning2" Text="Search" Visible="false" OnClick="buscarCerveza" />
                            </div>
                            <div class="form-group">
