<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update-customer.aspx.cs" Inherits="updateCustomer" %>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-lg-8 col-lg-offset-4">
                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-warning" Text="Submit" OnClick="registrarCliente"/>
