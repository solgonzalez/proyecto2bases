<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newSubCat.aspx.cs" Inherits="newSubCat" %>
                ...
                <div class="registrationform col-lg-offset-1">
                    <div class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label5" runat="server" Text="Corresponding Category" CssClass="col-lg-4 control-label"></asp:Label>                          
                                <div class="col-lg-5">
                                    <asp:DropDownList ID="categories" runat="server" CssClass="form-control ddl">
                                    </asp:DropDownList>                              
                                </div>
                            </div>
                            <div class="form-group">
