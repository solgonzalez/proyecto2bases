<%@ Page Language="C#" AutoEventWireup="true" CodeFile="top5cust.aspx.cs" Inherits="top5cust" %>
            ...
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6" style="background-color:#BD8D46">
                <div class="registrationform col-lg-offset-1">
                    <div class="form-horizontal">
                        <fieldset>
                            <legend>Here are our top customers</legend>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#1   </h3><asp:Label ID="lblcust1" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#2   </h3><asp:Label ID="lblcust2" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#3   </h3><asp:Label ID="lblcust3" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#4   </h3><asp:Label ID="lblcust4" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#5   </h3><asp:Label ID="lblcust5" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-3 col-lg-offset-6">
                                    <asp:HyperLink ID="btnBack" CssClass="btn btn-2 btn-1d" navigateURL="~/other.aspx" runat="server">Back</asp:HyperLink>
                                </div>
                            </div>
                        </fieldset>
                    </div>
