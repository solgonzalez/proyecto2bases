<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update-employee.aspx.cs" Inherits="update_employee" %>
                    ...
                    <div class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label1" runat="server" Text="New Username" CssClass="col-lg-2 control-label col-lg-offset-2"></asp:Label>
                                <div class="col-lg-5">
                                    <asp:TextBox ID="newUsername" runat="server" placeholder="Username" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label2" runat="server" Text="New Password" CssClass="col-lg-2 control-label col-lg-offset-2"></asp:Label>
                                <div class="col-lg-5">
