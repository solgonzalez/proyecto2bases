<%@ Page Language="C#" AutoEventWireup="true" CodeFile="top5beers.aspx.cs" Inherits="top5beers" %>
            ...
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6" style="background-color:#BD8D46">
                <div class="registrationform col-lg-offset-1">
                    <div class="form-horizontal">
                        <fieldset>
                            <legend>Here are our top picks</legend>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#1   </h3><asp:Label ID="lblbeer1" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#2   </h3><asp:Label ID="lblbeer2" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#3   </h3><asp:Label ID="lblbeer3" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#4   </h3><asp:Label ID="lblbeer4" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <h3 style="margin-left:400px">#5   </h3><asp:Label ID="lblbeer5" CssClass="control-label" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
