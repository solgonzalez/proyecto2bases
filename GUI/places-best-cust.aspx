<%@ Page Language="C#" AutoEventWireup="true" CodeFile="places-best-cust.aspx.cs" Inherits="places_best_cust" %>
            ...
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6" style="background-color:#BD8D46">
                <div class="registrationform col-lg-offset-1">
                    <div class="form-horizontal">
                        <fieldset>
                            <legend>Our best customers come from<i class="fa fa-pencil pull-right"></i></legend>
                            <div class="form-group">
                                <div class="col-lg-5 col-lg-offset-3">
                                    <asp:TextBox ID="bestCustResult" runat="server" TextMode="MultiLine" Rows="10" Enabled="false" CssClass="form-control2"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
