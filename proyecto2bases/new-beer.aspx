                    ...
                    <div class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <asp:TextBox ID="newDescription" runat="server" TextMode="MultiLine" Rows="1" CssClass="form-control3"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-10" style="width:80px;">
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ControlToValidate="newFerTime" runat="server" ErrorMessage="Only numbers allowed." ValidationExpression="\d+"></asp:RegularExpressionValidator>                             
                                </div>
                                <asp:Label ID="label9" runat="server" Text="Hours" CssClass="col-lg-2 control-label"></asp:Label>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="Label10" runat="server" Text="Fermentation Type" CssClass="col-lg-2 control-label col-lg-offset-2"></asp:Label>
                                <div class="col-lg-10" style="width:80px;">
                                    <asp:TextBox ID="TextBox1" runat="server" placeholder="0" CssClass="form-control"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ControlToValidate="newFerTime" runat="server" ErrorMessage="Only numbers allowed." ValidationExpression="\d+"></asp:RegularExpressionValidator>                             
                                </div>
                                <asp:Label ID="label11" runat="server" Text="Hours" CssClass="col-lg-2 control-label"></asp:Label>
                            </div>
